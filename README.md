[![Python application test with Github Actions](https://github.com/human-ak/pytest-tips-tricks/actions/workflows/test-ci.yml/badge.svg)](https://github.com/human-ak/pytest-tips-tricks/actions/workflows/test-ci.yml)
